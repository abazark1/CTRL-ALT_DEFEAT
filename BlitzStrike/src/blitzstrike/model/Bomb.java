...
//        System.out.println("The bomb is set to exploding");
     ...
     * directions (right, left, down, up) from the bomb's position and removes
     * the bomb after the explosion.
     *
    ...
    /**
     * Handles the explosion in a single direction. It checks each cell in the
     * direction of the explosion for a wall, box, or entity, affecting them as
     * needed.
     *
    ...
    /**
     * Checks and processes a single cell in the path of the explosion. Boxes
     * get destroyed, and walls neglected. Checks for the affected entities.
     *
     * @param position The position of the cell to check.
     * @param player1 The first player in the game.
     * @param player2 The second player in the game.
     * @param monsters The list of monsters present in the game.
     * @return true if the explosion can continue past this cell, false if it is
     * blocked.
     */
    private boolean checkAndProcessCell(Position position, Player player1, Player player2, ArrayList<Monster> monsters) {
        ...
        if (cell instanceof ObstacleBox) {
            ...
            // obstacles boxes get destroyed 
            ObstacleBox obsToRemove = ((ObstacleBox) cell);
            obsToRemove.getDestroyed();
    ...
    /**
     * Checks and affects entities at a specific position during an explosion.
     * If a player or monster is at the affected position, they will be marked
     * as dead or exploded, respectively.
     *
